...
function index3(){
  ...
  if (parseInt(skor) >= parseInt(kkm2)){
    window.location.href='../materi/index3.html';
  } else{
    isiTutor.innerHTML = 'Materi';
    $('#tutorialModal').modal('show');
  }
...
function sub3_1(){
  let skor = localStorage.getItem("nkuis2");
  if (parseInt(skor) >= parseInt(kkm2)){
    window.location.href='../materi/sub3_1.html';
  } else{
    isiTutor.innerHTML = 'Materi';
    $('#tutorialModal').modal('show');
  }
...
function sub3_2(){
  let skor = localStorage.getItem("nkuis2");
  if (parseInt(skor) >= parseInt(kkm2)){
    window.location.href='../materi/sub3_2.html';
  } else{
    isiTutor.innerHTML = 'Materi';
    $('#tutorialModal').modal('show');
  }
...
function kuis3(){
  let skor = localStorage.getItem("nkuis2");
  if (parseInt(skor) >= parseInt(kkm2)){
    window.location.href='../materi/kuis3.html';
  } else{
    isiTutor.innerHTML = 'Kuis';
    $('#tutorialModal').modal('show');
  }
...
/*subbab 4*/
function index4(){
  let skor = localStorage.getItem("nkuis3");
  if (parseInt(skor) >= parseInt(kkm3)){
    window.location.href='../materi/index4.html';
  } else{
    isiTutor.innerHTML = 'Materi';
    $('#tutorialModal').modal('show');
  }
...
function sub4_1(){
  let skor = localStorage.getItem("nkuis3");
  if (parseInt(skor) >= parseInt(kkm3)){
    window.location.href='../materi/sub4_1.html';
  } else{
    isiTutor.innerHTML = 'Materi';
    $('#tutorialModal').modal('show');
  }
...
function sub4_2(){
  let skor = localStorage.getItem("nkuis3");
  if (parseInt(skor) >= parseInt(kkm3)){
    window.location.href='../materi/sub4_2.html';
  } else{
    isiTutor.innerHTML = 'Materi';
    $('#tutorialModal').modal('show');
  }
...
function sub4_3(){
  let skor = localStorage.getItem("nkuis3");
  if (parseInt(skor) >= parseInt(kkm3)){
    window.location.href='../materi/sub4_3.html';
  } else{
    isiTutor.innerHTML = 'Materi';
    $('#tutorialModal').modal('show');
  }
...
function kuis4(){
  let skor = localStorage.getItem("nkuis3");
  if (parseInt(skor) >= parseInt(kkm3)){
    window.location.href='../materi/kuis4.html';
  } else{
    isiTutor.innerHTML = 'Kuis';
    $('#tutorialModal').modal('show');
  }
...
/*rangkuman*/
function rangkuman(){
  let skor = localStorage.getItem("nkuis4");
  if (parseInt(skor) >= parseInt(kkm4)){
