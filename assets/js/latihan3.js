...
function mulai3() {
    if ((namaD == "") && (kelasD == "") && (sekolahD == "")) {
        ...
        const dataKuis3 = document.getElementById('dataKuis3');
        dataKuis3.hidden = true;
        
        const latihan3 = document.getElementById('kuis3');
        latihan3.hidden = false;
...
function listsoal3() {
    let noSoal = 1;
        function getSoal(url, success, error){
            ...
            getSoal('../kuis/kuis3.json', (results) => {
...
let kuis3=[];
function cek(){
    kuis3=[kuis3_1,kuis3_2,kuis3_3,kuis3_4,kuis3_5];
}
        
function cekKuis3(){
    if ((kuis3_1 == "") || (kuis3_2 == "") || (kuis3_3 == "") || (kuis3_4 == "") || (kuis3_5 == "")) {
        $('#ModalKuisKosong').modal('show')
        $('#ModalSubmit3').modal('hide')
    } else {
        $('#ModalSubmit3').modal('hide')
        for (let a = 0; a < jawabB.length; a++) {
            if (kuis3[a] == jawabB[a]){
                const latihan3 = document.getElementById('kuis3');
                latihan3.hidden = true;
                const hasil3 = document.getElementById('hasilKuis3');
                hasil3.hidden = false;
                nilai = nilai + 20;
            }  
        }

        localStorage.setItem("nkuis3", nilai);
